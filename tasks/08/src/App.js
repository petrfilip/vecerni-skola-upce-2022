...
import ReactSuiteFilip from "./ReactSuiteFilip";
...
function App() {
    ...
    return (<Router>
            ...
            <NavDiv>
                        <AppLink to="/">Úvod</AppLink>
                        <AppLink to="/declarative-table">Deklarativní seznam</AppLink>
                        <AppLink to="/declarative-table-with-filters">Deklarativní seznam s filtrem</AppLink>
                        <AppLink to="/react-suite">React suite</AppLink>
            </NavDiv>
            ...
            <Switch>
                ...
                <Route path={`/react-suite`}>
                    <ReactSuiteFilip data={todos}/>
                </Route>
                <Route path="/">
